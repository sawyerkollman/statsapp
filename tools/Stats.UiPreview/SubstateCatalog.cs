...
internal static class SubstateCatalog
{
    private static readonly Dictionary<string, string[]> ByView = new()
    {
        ...
        ["sessions"] = new[] { "recorded", "analysis", "slow-frames", "theme-cycle" },
        ["theme-studio"] = new[] { "theme-cycle" },
        ["scenes"] = Array.Empty<string>(),
        ["lab"] = new[] { "gaming", "compound", "history", "timeline", "diagnostics", "notebook", "support" },
        ...
        ["overlay-editor"] = Array.Empty<string>(),
