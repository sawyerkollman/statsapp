...
/// its App.xaml startup URI, never touches its elevation/tray/production-settings paths. Merges the same five
...
public sealed class PreviewApp : Application
{
    ...
    public static PreviewApp EnsureCreated()
    {
        ...
        _instance.Resources.MergedDictionaries.Add(Load("Icons.xaml"));
